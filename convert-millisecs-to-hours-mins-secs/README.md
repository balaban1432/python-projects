...
- Write program that converts the given milliseconds into hours, minutes, and seconds. The program should convert only from milliseconds to hours/minutes/seconds, not vice versa and during the conversion following notes should be taken into consideration.
   ...
   - If the milliseconds is greater than 1000, remainder milliseconds should not be shown in the output. Milisaniye 1000'den büyükse, çıktıda kalan milisaniye gösterilmemelidir.

   - If milliseconds given is less than 1000, only milliseconds should be shown in the output. Verilen milisaniye 1000'den az ise çıktıda sadece milisaniye gösterilmelidir.
